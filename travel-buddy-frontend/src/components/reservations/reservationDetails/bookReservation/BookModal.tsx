...
import { useBookReservationMutation } from "@/redux/features/bookingApis";
    ...
    const option = {
      data: {
        ...
        hotelId:
          ...
          "_id" in reservation.hotelId
            ? String((reservation.hotelId as IBusinessProfile)._id)
            : String(reservation.hotelId),
        reservationId: String(reservation._id),
        reservedDays: totalNights,
        startingDate: new Date(dates[0].startDate).toISOString(),
        expireDate: new Date(dates[0].endDate).toISOString(),
        reservationPrice: totalPrice,
        isAsGuest: user ? false : true,
      },
    };
