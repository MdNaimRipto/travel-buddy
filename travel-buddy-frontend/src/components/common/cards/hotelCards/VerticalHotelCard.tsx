    ...
    <div className="group">
      ...
      <div className="px-3 overflow-hidden">
        ...
        <div className="flex items-center gap-2 whitespace-nowrap text-sm text-gray pb-3 mb-3 border-b border-b-lightGray">
          <p className="titleFont">{`Cox's Bazar`}</p>
        ...
        <div>
          <p className="mb-1 pt-2 text-sm titleFont font-medium text-black">
            Starting From:
          </p>
          <div className="flex items-center justify-between">
            <p className="text-black">
              <span className="text-xl text-black titleFont">BDT.3000</span>{" "}
